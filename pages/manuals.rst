...
`Main Room Storage Heater Quick Start </documents/storage_heater_main_room_quick_start.pdf>`_ |br|
`Main Room Storage Heater Manual </documents/storage_heater_main_room_manual.pdf>`_ |br|
`Main Room Storage Heater FAQs </documents/storage_heater_main_room_faq.pdf>`_ |br|
`Microwave </documents/microwave.pdf>`_ |br|
`Oven - manual for a similar oven </documents/oven.pdf>`_ |br|
`Toaster </documents/toaster.pdf>`_ |br|
`Vacuum Cleaner <https://www.bosch-home.co.uk/manual/8001278398>`_ |br|
